...
use nncombinator::optimizer::{AdagradBuilder, AdamBuilder, AdamWBuilder, MomentumSGDBuilder, RMSpropBuilder, SGDBuilder};
...
fn test_mnist_for_cpu_with_persistence() {
    ...
    let nn_path = Path::new("data").join("tmp").join("mnist_for_cpu_with_persistence.bin");
...
#[test]
fn test_mnist_for_cpu_with_text_persistence() {
    let mut rnd = prelude::thread_rng();
    let rnd_base = Rc::new(RefCell::new(XorShiftRng::from_seed(rnd.gen())));
    ...
    let nn_path = Path::new("data").join("tmp").join("mnist_for_cpu_with_persistence.txt");
...
#[test]
fn test_gpu_with_persist_progress_all_optimizers() {
    let mut rnd = prelude::thread_rng();
    let rnd_base = Rc::new(RefCell::new(XorShiftRng::from_seed(rnd.gen())));
...
#[test]
fn test_gpu_with_persist_to_text_progress_all_optimizers() {
    let mut rnd = prelude::thread_rng();
    let rnd_base = Rc::new(RefCell::new(XorShiftRng::from_seed(rnd.gen())));
    ...
    let nn_path = Path::new("data").join("tmp").join("test_gpu_with_persist_to_text_progress_all_optimizers.txt");
...
fn test_cpu_with_persist_progress_all_layears() {
    ...
    let nn_path = Path::new("data").join("tmp").join("test_cpu_with_persist_progress_all_layears.bin");
...
#[test]
fn test_cpu_with_persist_to_text_progress_all_layears() {
    let mut rnd = prelude::thread_rng();
    let rnd_base = Rc::new(RefCell::new(XorShiftRng::from_seed(rnd.gen())));
    ...
    let nn_path = Path::new("data").join("tmp").join("test_cpu_with_persist_to_text_progress_all_layears.txt");
...
#[test]
fn test_cpu_with_persist_progress_all_optimizers() {
    let mut rnd = prelude::thread_rng();
    let rnd_base = Rc::new(RefCell::new(XorShiftRng::from_seed(rnd.gen())));
    ...
    let nn_path = Path::new("data").join("tmp").join("test_cpu_with_persist_progress_all_optimizers.bin");
...
#[test]
fn test_cpu_with_persist_to_text_progress_all_optimizers() {
    let mut rnd = prelude::thread_rng();
    let rnd_base = Rc::new(RefCell::new(XorShiftRng::from_seed(rnd.gen())));
    ...
    let nn_path = Path::new("data").join("tmp").join("test_cpu_with_persist_to_text_progress_all_optimizers.txt");
